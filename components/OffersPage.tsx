              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <div className="mt-auto space-y-4">
                    <div className="bg-white/80 backdrop-blur-md rounded-[2rem] p-2 flex flex-col sm:flex-row items-stretch sm:items-center border-2 border-white shadow-inner transition-all overflow-hidden gap-3">
                       {/* Code Field */}
                       <div className="flex-grow px-6 py-4 sm:py-0 font-black tracking-[0.2em] text-xl md:text-2xl text-[#151e63] text-center bg-gray-50/50 rounded-2xl sm:bg-transparent">
                          {offer.code}
                       </div>
                       ...
                       <button 
                         ...
                         className={cn(
                           "h-14 sm:h-16 px-8 rounded-2xl flex items-center justify-center gap-3 font-black transition-all shrink-0 active:scale-95 shadow-lg",
