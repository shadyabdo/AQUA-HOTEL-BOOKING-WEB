...
const faqs = [
  ...
  },
  {
    ...
    answer: "نعتمد حالياً على نظام المحفظة الإلكترونية الخاصة بـ AQUA لتجربة حجز سريعة وآمنة، بالإضافة إلى دعم بطاقات الدفع الافتراضية للتجربة التفاعلية للنظام."
  },
  {
    id: 5,
    category: "booking",
